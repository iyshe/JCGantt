...
function TimSort(array, compare) {
  ...
  function mergeAt(i) {
    ...
    length22 = gallopLeft(array[start1 + length1 - 1], array, start2, length22, length22 - 1, compare);
    if (length22 === 0) {
      return;
    }
    if (length1 <= length22) {
  ...
  function mergeLow(start1, length1, start2, length22) {
    ...
    while (1) {
      ...
      do {
        ...
        count2 = gallopLeft(tmp[cursor1], array, cursor2, length22, 0, compare);
        if (count2 !== 0) {
          for (i = 0; i < count2; i++) {
            array[dest + i] = array[cursor2 + i];
          }
  ...
  function mergeHigh(start1, length1, start2, length22) {
    ...
    while (true) {
      ...
      do {
        ...
        count2 = length22 - gallopLeft(array[cursor1], tmp, 0, length22, length22 - 1, compare);
        if (count2 !== 0) {
          dest -= count2;
          cursor2 -= count2;
          length22 -= count2;
...
var Track = function() {
  ...
  Track2.prototype.step = function(target, percent) {
    ...
    var w = interval === 0 ? 1 : mathMin5((percent - frame.percent) / interval, 1);
...
var tmpAngles = [];
function modPI2(radian2) {
  var n = Math.round(radian2 / PI * 1e8) / 1e8;
  return n % 2 * PI;
}
...
var morphPath_exports = {};
__export(morphPath_exports, {
...
function split(path, count) {
  ...
  switch (path.type) {
    ...
    default:
      ...
      var scale3 = m2 ? Math.sqrt(Math.max(m2[0] * m2[0] + m2[1] * m2[1], m2[2] * m2[2] + m2[3] * m2[3])) : 1;
...
var DropletShape = function() {
  function DropletShape2() {
    this.cx = 0;
    this.cy = 0;
    this.width = 0;
    this.height = 0;
  }
  return DropletShape2;
}();
var Droplet = function(_super) {
  __extends(Droplet2, _super);
  function Droplet2(opts) {
    return _super.call(this, opts) || this;
  }
  Droplet2.prototype.getDefaultShape = function() {
    return new DropletShape();
  };
  Droplet2.prototype.buildPath = function(ctx, shape) {
    var x = shape.cx;
    var y = shape.cy;
    var a = shape.width;
    var b = shape.height;
...
var Heart = function(_super) {
  ...
  function Heart2(opts) {
    return _super.call(this, opts) || this;
  }
  Heart2.prototype.getDefaultShape = function() {
    return new HeartShape();
  };
  Heart2.prototype.buildPath = function(ctx, shape) {
    var x = shape.cx;
    var y = shape.cy;
    var a = shape.width;
    var b = shape.height;
...
var Isogon = function(_super) {
  __extends(Isogon2, _super);
  function Isogon2(opts) {
    return _super.call(this, opts) || this;
  }
  Isogon2.prototype.getDefaultShape = function() {
    return new IsogonShape();
  };
  Isogon2.prototype.buildPath = function(ctx, shape) {
    var n = shape.n;
    if (!n || n < 2) {
      return;
    }
...
var Rose = function(_super) {
  ...
  Rose2.prototype.getDefaultStyle = function() {
    return {
      stroke: "#000",
      fill: null
    };
  };
  Rose2.prototype.getDefaultShape = function() {
    return new RoseShape();
  };
  Rose2.prototype.buildPath = function(ctx, shape) {
    var R = shape.r;
    var k = shape.k;
    var n = shape.n;
    var x0 = shape.cx;
...
var Star = function(_super) {
  ...
  Star2.prototype.getDefaultShape = function() {
    return new StarShape();
  };
  Star2.prototype.buildPath = function(ctx, shape) {
    var n = shape.n;
    if (!n || n < 2) {
      return;
    }
    ...
    var r0 = shape.r0;
    if (r0 == null) {
      r0 = n > 4 ? r * cos3(2 * PI6 / n) / cos3(PI6 / n) : r / 3;
    }
    var dStep = PI6 / n;
    var deg = -PI6 / 2;
    var xStart = x + r * cos3(deg);
    var yStart = y + r * sin3(deg);
    deg += dStep;
    ctx.moveTo(xStart, yStart);
    for (var i = 0, end2 = n * 2 - 1, ri = void 0; i < end2; i++) {
      ri = i % 2 === 0 ? r0 : r;
...
var TrochoidShape = function() {
  ...
  return TrochoidShape2;
}();
var Trochoid = function(_super) {
  __extends(Trochoid2, _super);
  function Trochoid2(opts) {
    return _super.call(this, opts) || this;
  }
  Trochoid2.prototype.getDefaultStyle = function() {
    return {
      stroke: "#000",
      fill: null
    };
  };
  Trochoid2.prototype.getDefaultShape = function() {
    return new TrochoidShape();
  };
  Trochoid2.prototype.buildPath = function(ctx, shape) {
    var R = shape.r;
    var r = shape.r0;
    var d = shape.d;
...
var Trochoid_default = Trochoid;

// node_modules/zrender/lib/graphic/Pattern.js
var Pattern = function() {
  function Pattern2(image, repeat) {
    this.image = image;
    this.repeat = repeat;
    this.x = 0;
    this.y = 0;
...
var DebugRect = function() {
  ...
  DebugRect2.prototype.update = function(rect) {
  ...
  DebugRect2.prototype.hide = function() {
    this.dom.style.opacity = "0";
  };
  DebugRect2.prototype.show = function(autoHideDelay) {
    var _this = this;
  ...
  zr.on("rendered", function() {
    if (painter.getLayers) {
      ...
      painter.eachBuiltinLayer(function(layer) {
        ...
        for (var i2 = 0; i2 < paintRects.length; i2++) {
          if (!paintRects[i2].width || !paintRects[i2].height) {
            continue;
          }
          if (!debugRects[idx_1]) {
          ...
          debugRects[idx_1].update(paintRects[i2]);
          idx_1++;
        }
      });
...
var SVGPathRebuilder = function() {
  ...
  SVGPathRebuilder2.prototype.ellipse = function(cx, cy, rx, ry, psi, startAngle, endAngle, anticlockwise) {
    ...
    if (isCircle) {
      ...
      large = unifiedTheta >= PI7 === !!clockwise;
    }
...
function setTransform(attrs, m2, compress) {
  if (m2 && !(noTranslate(m2) && noRotateScale(m2))) {
    ...
    attrs.transform = noRotateScale(m2) ? "translate(" + round2(m2[4] * mul3) / mul3 + " " + round2(m2[5] * mul3) / mul3 + ")" : getMatrixStr(m2);
  }
}
function convertPolyShape(shape, attrs, mul3) {
  ...
  for (var i = 0; i < points2.length; i++) {
    strArr.push(round2(points2[i][0] * mul3) / mul3);
    strArr.push(round2(points2[i][1] * mul3) / mul3);
  }
...
var Painter_default2 = SVGPainter;

// node_modules/zrender/lib/all.js
registerPainter("canvas", Painter_default);
...
export {
  ...
  BezierCurveShape,
  BoundingRect_default as BoundingRect,
  Circle_default as Circle,
  CircleShape,
  CompoundPath_default as CompoundPath,
  ...
  IncrementalDisplayable_default as IncrementalDisplayable,
  Isogon_default as Isogon,
  IsogonShape,
  Line_default as Line,
  LineShape,
  LinearGradient_default as LinearGradient,
  OrientedBoundingRect_default as OrientedBoundingRect,
  ...
  morphPath_exports as morph,
  parseSVG,
  path_exports2 as path,
  registerPainter,
  setPlatformAPI,
  showDebugDirtyRect,
